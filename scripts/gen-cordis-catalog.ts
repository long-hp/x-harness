...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  packBindings: 'pack.md',
  packController: 'pack.md',
  packMount: 'pack.md',
  packs: 'pack.md',
  skills: 'skills.md',
  spillStore: 'spill.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  PackBinding: 'pack.md',
  PackBindingListValue: 'pack.md',
  PackBindingValue: 'pack.md',
  PackCatalogSnapshot: 'pack.md',
  PackCatalogValue: 'pack.md',
  PackDefinition: 'pack.md',
  PackId: 'pack.md',
  PackLookupOptions: 'pack.md',
  PackProvider: 'pack.md',
  PackProviderControl: 'pack.md',
  PackSummary: 'pack.md',
